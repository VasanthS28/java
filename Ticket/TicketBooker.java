...
public class TicketBooker
{
    ...
    static Map<Integer, user> passengers = new HashMap<>();//map of passenger ids to passengers

    //book ticket
    public void bookTicket(user p, int berthInfo,String allotedBerth)
    {
    ...
    //adding to RAC
    public void addToRAC(user p,int racInfo,String allotedRAC)
    {
    ...
    //adding to WL
    public void addToWaitingList(user p,int waitingListInfo,String allotedWL)
    {
    ...
    public void cancelTicket(int passengerId)
    {
        ...
        user p = passengers.get(passengerId);
        ...
        if(racList.size() > 0)
        {
            ...
            user passengerFromRAC = passengers.get(racList.poll());
            ...
            if(waitingList.size()>0)
            {
                ...
                user passengerFromWaitingList = passengers.get(waitingList.poll());
